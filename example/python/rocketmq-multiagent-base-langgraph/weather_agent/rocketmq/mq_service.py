"""RocketMQ client management for Weather Agent"""
import logging
...
from weather_agent.config.config import ENDPOINT, ACCESS_KEY, SECRET_KEY, CONSUMER_GROUP, WEATHER_AGENT_TOPIC
...
def init_rocketmq(message_handler) -> None:
    ...
    try:
        ...
        lite_push_consumer = build_push_consumer(
            ...
            message_listener=WeatherMessageListener(message_handler)
        )
